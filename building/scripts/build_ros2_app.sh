...
build_directory=/buildroot/build-ros2
...
cmake -B "${build_directory}" -DCMAKE_BUILD_TYPE="${cmake_build_type}"  -G Ninja -S /temporary/code/application_ros2 -DCMAKE_PREFIX_PATH=/opt/ros/jazzy
