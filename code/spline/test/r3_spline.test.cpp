...
TEST(Spline_r3Spline, TestInvalidEvaluateConditions) {
    ...
    EXPECT_EQ(spline::EvaluateSpline<spline::R3Spline>(115, r3_spline), std::nullopt);
    ...
    EXPECT_NE(spline::EvaluateSpline<spline::R3Spline>(100, r3_spline),
              std::nullopt);  // Inside first time segment - valid
    EXPECT_EQ(spline::EvaluateSpline<spline::R3Spline>(105, r3_spline),
    ...
    r3_spline.control_points.push_back(Eigen::Vector3d::Zero());
    EXPECT_NE(spline::EvaluateSpline<spline::R3Spline>(105, r3_spline), std::nullopt);
}
...
TEST(Spline_r3Spline, TestEvaluate) {
    ...
    // Position
    auto const p_0{spline::EvaluateSpline<spline::R3Spline>(100, r3_spline)};
    ASSERT_TRUE(p_0.has_value());
    EXPECT_TRUE(p_0.value().isApproxToConstant(1));

    // Velocity
    auto const v_0{spline::EvaluateSpline<spline::R3Spline>(100, r3_spline, spline::DerivativeOrder::First)};
    ASSERT_TRUE(v_0.has_value());
    EXPECT_TRUE(v_0.value().isApproxToConstant(0.2));  // 1m/5ns

    // Acceleration
    auto const a_0{spline::EvaluateSpline<spline::R3Spline>(100, r3_spline, spline::DerivativeOrder::Second)};
    ...
    auto const p_1{spline::EvaluateSpline<spline::R3Spline>(105, r3_spline)};
...
TEST(Spline_r3Spline, TestTemplatedEvaluateOnLine) {
    ...
    Vector3d const position_1{
        spline::R3Spline::Evaluate<double, spline::DerivativeOrder::Null>(P1, 0, delta_t_ns)};
    ...
    Vector3d const position_2{
        spline::R3Spline::Evaluate<double, spline::DerivativeOrder::Null>(P1, 0.999999, delta_t_ns)};
    ...
    Vector3d const position_3{
        spline::R3Spline::Evaluate<double, spline::DerivativeOrder::Null>(P2, 0, delta_t_ns)};
...
TEST(Spline_r3Spline, TestTemplatedEvaluateOnParabola) {
    ...
    Vector3d const position{
        spline::R3Spline::Evaluate<double, spline::DerivativeOrder::Null>(P1, u_middle, delta_t_ns)};
    ...
    Vector3d const velocity{
        spline::R3Spline::Evaluate<double, spline::DerivativeOrder::First>(P1, u_middle, delta_t_ns)};
    ...
    Vector3d const acceleration{
        spline::R3Spline::Evaluate<double, spline::DerivativeOrder::Second>(P1, u_middle, delta_t_ns)};
