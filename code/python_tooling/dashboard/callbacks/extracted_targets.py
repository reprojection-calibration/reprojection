...
app.clientside_callback(
    """
    function(frame_indices, targets, step_id, workflow_data, cmax_values, stage_id, composite_ids) {
        function renderCamera(composite_id) {
        ...
        // Update every camera from the same slider event, regardless of its asset ID.
        return composite_ids.map(renderCamera);
    }
    """,
    Output({"type": "extracted_targets", "asset_id": ALL}, "figure"),
    Input(
    ...
    State({"type": "extracted_targets", "asset_id": ALL}, "id"),
)
