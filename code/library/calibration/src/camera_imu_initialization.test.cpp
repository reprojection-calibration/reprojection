...
TEST(CalibrationCameraImuInitialization, TestEstimateGravity) {
    ...
    auto const [_1, tf_co_w]{testing_mocks::GenerateMvgData(sensor, gt_intrinsics, duration_s, 10)};

    spline::Se3Spline const spline_co_w{spline::InitializeSe3SplineState(tf_co_w, 50)};
