...
class SplineCostFunction_T {
   public:
    ...
    bool operator()(T const* const control_point_0_ptr, T const* const control_point_1_ptr,
        ...
        Eigen::Map<const Matrix3<T>> p0(control_point_0_ptr);
        Eigen::Map<const Matrix3<T>> p1(control_point_1_ptr);
        Eigen::Map<const Matrix3<T>> p2(control_point_2_ptr);
        Eigen::Map<const Matrix3<T>> p3(control_point_3_ptr);
