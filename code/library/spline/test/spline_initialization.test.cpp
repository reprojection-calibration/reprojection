...
TEST(SplineSplineInitialization, TestInitializeSpline) {
    ...
    CubicBSplineC3 const one_segment_spline{CubicBSplineC3Init::Initialize(measurements, 1)};
    ...
    CubicBSplineC3 const two_segment_spline{CubicBSplineC3Init::Initialize(measurements, 2)};
