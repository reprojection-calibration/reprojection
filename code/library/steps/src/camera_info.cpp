...
CameraInfo CameraInfoStep::Load(database::SqlitePtr const& db) const {
...
void CameraInfoStep::Save(CameraInfo const& camera_info, database::SqlitePtr const& db) const {
